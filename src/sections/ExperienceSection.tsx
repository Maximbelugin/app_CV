...
const experiences: Experience[] = [
  {
    ...
    description: [
      "Лидирование цифровизации аналитического направления; управление кросс-функциональными проектами",
    ...
    achievements: [
      "Разработал и внедрил 10+ BI-дашбордов (PowerBI, Sber Navigator), охватывающих ключевые направления аналитики",
      "Автоматизировал подготовку управленческой отчётности через ETL-пайплайны на Python/SQL",
      "Разработал и курировал авторский курс «ПСБ Академия» — обучено 50+ сотрудников банка",
  ...
  },
  {
    ...
    description: [
      "Product Owner «Вклады в проекте Динбаланс»: разработка и внедрение ПРОМО-механик на вкладах",
    ...
    achievements: [
      "Настроил ПРОМО-механику по вкладам и текущим счетам",
      "Автоматизировал обновления данных по нормативам ликвидности, сократив подготовку отчетности до минут вместо часов",
      "Выстроил взаимодействие с IT по настройке витрин данных",
  ...
  },
  {
    ...
    achievements: [
      "Выстроил процесс управления ликвидностью, контроля нормативов и подготовки регуляторной отчётности",
      "Внедрил data driven подход в смежных подразделениях",
    ],
  },
  {
    bank: "ВТБ",
    ...
    achievements: [
      "Обеспечил процесс управления кредитными рисками",
      "Настроил эффективную коммуникацию по оценки рисков на группы связанных заемщиков",
    ],
  },
  {
    bank: "Уралсиб",
    ...
    achievements: [
      "Обеспечил контроль лимитов и фондирование ключевых направлений",
    ],
  },
];
